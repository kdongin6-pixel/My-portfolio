...
| `src/vision.js` | 📷 매매 스크린샷 인식(앱 내장, 백업 경로) — Claude API 비전, Anthropic API 키 별도 필요·과금 발생. **주 경로는 채팅에 스크린샷 첨부 → `agent_apply`** (docs/agents/screenshot-trade-import.md, 과금 없음) |
