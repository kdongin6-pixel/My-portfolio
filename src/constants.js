...
// 상수
// ═══════════════════════════════════════════
export const TC_DEFAULT={"AI·빅테크":"#818cf8","AI·데이터센터":"#a78bfa","전력·원전":"#f59e0b","반도체":"#38bdf8","양자컴퓨팅":"#e879f9","미국지수·코어":"#60a5fa","레버리지·지수":"#f43f5e","레버리지·개별주":"#fb7185","헬스케어":"#34d399","배당·방어":"#10b981","가치·복합금융":"#fbbf24","초단기채·현금성":"#06b6d4","디지털자산·고변동":"#f97316"};
export const DEFAULT_TAGS=["AI·빅테크","AI·데이터센터","전력·원전","반도체","양자컴퓨팅","미국지수·코어","레버리지·지수","레버리지·개별주","헬스케어","배당·방어","가치·복합금융","초단기채·현금성","디지털자산·고변동"];
export const APP_VERSION="v0.7.1-taxonomy";
